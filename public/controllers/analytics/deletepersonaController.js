flickmiApp.controller('deletepersonaController', function($http, $scope, $rootScope,mainInfoFactory) {
   ...
   var url=$scope.mainurl+'search?q=deletePersona&dateRange=day';// by default show one day data
	...
	var url=$scope.mainurl+'search?q=DeletePersona_DeleteConnections&dateRange=day';// by default show one day data
    $http({
        method : "GET",
        url : url,
        headers: {'Content-Type': 'application/x-www-form-urlencoded'}
    }).success(function(data, status, headers, config) {
      drawLineChart(data.results,'deleteconnections');
    });
	var url=$scope.mainurl+'search?q=DeletePersona_AssignDiffPersona&dateRange=day';// by default show one day data
    $http({
        method : "GET",
        url : url,
        headers: {'Content-Type': 'application/x-www-form-urlencoded'}
    }).success(function(data, status, headers, config) {
      drawLineChart(data.results,'assigndifferentpersona');
    });
	var url=$scope.mainurl+'search?q=DeletePersona_ManualSelection&dateRange=day';// by default show one day data
    $http({
        method : "GET",
        url : url,
        headers: {'Content-Type': 'application/x-www-form-urlencoded'}
    }).success(function(data, status, headers, config) {
      drawLineChart(data.results,'manualselection');
    });
	var url=$scope.mainurl+'search?q=DeletePersona_CancelDelete&dateRange=day';// by default show one day data
    $http({
        method : "GET",
        url : url,
        headers: {'Content-Type': 'application/x-www-form-urlencoded'}
    }).success(function(data, status, headers, config) {
      drawLineChart(data.results,'canceldelete');
    });
    ...
    nv.addGraph(function() {
        ...
        $('.nv-pie .nv-pie .nv-slice').click(function(e){
           ...
           if(id=='deviceChart' && $scope.currentCountry!=""){
				...
				var url=$scope.mainurl+'search?q=deletePersona&dateRange=day&country='+$scope.currentCountry+'&device='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
				...
				$scope.currentdevice=pieChartText;
				var url=$scope.mainurl+'search?q=deletePersona&dateRange=day&device='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
				...
				$scope.currentbrowser=pieChartText;
				var url=$scope.mainurl+'search?q=deletePersona&dateRange=day&device='+$scope.currentdevice+'&browser='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
				...
				$scope.currentbrowser=pieChartText;
				var url=$scope.mainurl+'search?q=deletePersona&dateRange=day&&country='+$scope.currentCountry+'&device='+$scope.currentdevice+'&browser='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
   ...
   function chartsUpdate(Country){
		...
		var url=$scope.mainurl+'search?q=deletePersona&dateRange=day&country='+Country;
        $http({
				method : "GET",
				url : url,
				headers: {'Content-Type': 'application/x-www-form-urlencoded'}
