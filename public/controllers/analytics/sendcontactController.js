flickmiApp.controller('sendcontactController', function($http, $scope, $rootScope,mainInfoFactory) {
    ...
    nv.addGraph(function() {
        ...
        $('.nv-pie .nv-pie .nv-slice').click(function(e){
           ...
           if(id=='deviceChart' && $scope.currentCountry!=""){
				...
				var url=$scope.mainurl+'search?q=contactsShared&dateRange=day&country='+$scope.currentCountry+'&device='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
				...
				var url=$scope.mainurl+'search?q=contactsShared&dateRange=day&device='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
				...
				var url=$scope.mainurl+'search?q=contactsShared&dateRange=day&device='+$scope.currentdevice+'&browser='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
				...
				var url=$scope.mainurl+'search?q=contactsShared&dateRange=day&&country='+$scope.currentCountry+'&device='+$scope.currentdevice+'&browser='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
   ...
   function chartsUpdate(Country){
		...
		var url=$scope.mainurl+'search?q=contactsShared&dateRange=day&country='+Country;
        $http({
				method : "GET",
				url : url,
				headers: {'Content-Type': 'application/x-www-form-urlencoded'}
