flickmiApp.controller('viewcontactsController', function($http, $scope, $rootScope,mainInfoFactory) {
    ...
    nv.addGraph(function() {
        ...
        $('.nv-pie .nv-pie .nv-slice').click(function(e){
           ...
           if(id=='deviceChart' && $scope.currentCountry!=""){
				...
				var url=$scope.mainurl+'search?q=viewContactsList&dateRange=day&country='+$scope.currentCountry+'&device='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
				...
				$scope.currentdevice=pieChartText;
				var url=$scope.mainurl+'search?q=viewContactsList&dateRange=day&device='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
				...
				var url=$scope.mainurl+'search?q=viewContactsList&dateRange=day&device='+$scope.currentdevice+'&browser='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
				...
				$scope.currentbrowser=pieChartText;
				var url=$scope.mainurl+'search?q=viewContactsList&dateRange=day&&country='+$scope.currentCountry+'&device='+$scope.currentdevice+'&browser='+pieChartText;
                $http({
                        method : "GET",
						url : url,
						headers: {'Content-Type': 'application/x-www-form-urlencoded'}
   ...
   function chartsUpdate(Country){
		...
		var url=$scope.mainurl+'search?q=viewContactsList&dateRange=day&country='+Country;
        $http({
				method : "GET",
				url : url,
				headers: {'Content-Type': 'application/x-www-form-urlencoded'}
